...
;
class playerAssitantPrompt {
    constructor(request, previousMessages, dataFolder) {
        const { worldName, status, date, message, player } = request;
        ...
        let pr0file = {};
        if (profileId !== "") {
            pr0file = RpProfile_1.default.getRpProfileFromId(profileId);
        }
        ;
...
exports.default = playerAssitantPrompt;
